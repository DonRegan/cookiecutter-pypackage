...
copyright = u'{{ cookiecutter.year }}, {{ cookiecutter.credits }}'
...
latex_documents = [
  ('index', '{{ cookiecutter.package_name }}.tex', u'{{ cookiecutter.project_name }} Documentation',
...
man_pages = [
    ('index', '{{ cookiecutter.package_name }}', u'{{ cookiecutter.project_name }} Documentation',
...
texinfo_documents = [
  ('index', '{{ cookiecutter.package_name }}', u'{{ cookiecutter.project_name }} Documentation',
   u'{{ cookiecutter.full_name }}', '{{ cookiecutter.package_name }}', 'One line description of project.',
   'Miscellaneous'),
]
